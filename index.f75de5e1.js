...
document.addEventListener("click", (e)=>{
    if (e.target.classList.contains("wall")) {
        ...
        const spiderX = Math.max(0, Math.min(e.clientX - wallLeft - wallBorderWidth - spiderWidth / 2, maxX));
        const spiderY = Math.max(0, Math.min(e.clientY - wallTop - wallBorderWidth - spiderHeight / 2, maxY));
